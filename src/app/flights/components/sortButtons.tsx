...
export default function SortButtons(){
    ...
    return (
        ...
        <button className={`${sortType === 'arrival_time' ? '!bg-blue-600 text-white':''} px-4 py-2 rounded bg-white   shadow hover:bg-blue-700 hover:text-white`} onClick={() => handleSortType('arrival_time')}>Arrival</button>
